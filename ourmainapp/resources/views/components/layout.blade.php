  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Our Main App</a></h4>
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/about" class="text-white">Single Post App</a></h4>
